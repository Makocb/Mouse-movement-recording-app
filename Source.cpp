...
void wmCreate(HWND hWnd, WPARAM wp, LPARAM lp, int& trackPos)
{
        ...
        hwndButton1 = CreateWindow(
            ...
            4 * globals::CLIENT_SIZE_X / 9,         // x position 
            4 * globals::CLIENT_SIZE_Y / 9,         // y position 
            globals::CLIENT_SIZE_X / 9,        // Button width
            globals::CLIENT_SIZE_Y / 9,        // Button height
            hWnd,                     // Parent window
            NULL,                     // No menu.
        ...
        hwndButton2 = CreateWindow(
            ...
            WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,  // Styles 
            4 * globals::CLIENT_SIZE_X / 9,         // x position 
            3 * globals::CLIENT_SIZE_Y / 9,         // y position 
            globals::CLIENT_SIZE_X / 9,        // Button width
            globals::CLIENT_SIZE_Y / 9,        // Button height
            hWnd,                     // Parent window
            NULL,                     // No menu.
...
{   
    ...
    case WM_CREATE:    wmCreate(hWnd, wParam, lParam, trackPos);                  break;
    case WM_COMMAND:   wmCommand(hWnd, wParam, lParam, fout, timer, elapsedUpdate, trackPos);    break;
